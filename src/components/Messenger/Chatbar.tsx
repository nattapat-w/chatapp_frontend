  ...
  return (
    <>
      <li>
        <a
          href="#"
          className="flex items-center p-2 rounded-lg dark:text-dark hover:bg-gray-100 dark:hover:bg-gray"
        >
          <img
            ...
            alt="Profile Image"
          ></img>
          <span className="flex-1 ms-3 whitespace-nowrap dark:text-dark-text">{fullname}</span>
          {notification !== 0 ? (
